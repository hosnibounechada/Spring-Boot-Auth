...
@Operation(summary = "Activate user account", description = "User must confirm his account by entering the provided 6 digits code in their email")
...
@ApiResponse(description = "Not found, Wrong code or Already expired", responseCode = "404", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})

public @interface ConfirmEmailSwagger {
}
